...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        ...
        protected void OnEnable()
        {
            ...
            m_actionOverrRideProperty = serializedObject.FindProperty("m_OverRideActionLabel");
            m_actionOverrRideStringProperty = serializedObject.FindProperty("m_ActionLabelString");
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                EditorGUILayout.PropertyField(m_actionOverrRideProperty);
                
                if (m_RebindActionUI.m_OverRideActionLabel)
                {
                    EditorGUILayout.PropertyField(m_actionOverrRideStringProperty);
                }
            }
        ...
        private SerializedProperty m_actionOverrRideProperty;
        private SerializedProperty m_actionOverrRideStringProperty;
